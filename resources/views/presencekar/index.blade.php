    ...
    <div class="card p-3">
        <div class="row align-items-center">
            <div class="col-12 col-md-6 ">
                <a href="{{ route('admin.presencekar.export', ['date' => $date]) }}" class="btn btn-success rounded ">
            ...
            <div class="col-12 col-md-6 mt-3 mt-md-0 ">
                <form action="{{ route('admin.presencekaryawan.index') }}" method="GET">
                    {{-- @csrf --}}
        ...
        <div class="d-inline-block">
            <a href="{{ route('admin.add.presencekar') }}" class="btn btn-warning">tambah data presensi</a>
        </div>
