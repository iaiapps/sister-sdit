...
@section('content')
    ...
    <div class="card rounded p-3 mt-3 d-block text-center ">
        <p class="fs-5">Akun anda belum aktif, silahkan hubungi "Admin" untuk mengaktifkan Akun <span><a
                    href="https://wa.me/6285232213939" target="_blank" class="btn btn-success mb-3 ">Hubungi
                    Admin</a></span></p>
